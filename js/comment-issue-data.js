// 评论issues仓库 by.dgfatt https://dgfatt.github.io/
var repoIssuesUrl = "https://api.github.com/repos/dgfatt/blog_comment/issues";
// 对应仓库 clientId、clientSecret 关于这两个参数的安全问题，查看 https://removeif.github.io/2019/09/19/博客源码分享.html#1-热门推荐，最新评论：
var clientId = "d26fa875de88dbddccf3";
var clientSecret = "b4d9dc60566e080838b9c0370b31a4399ec9175b";
...
// 评论缓存key
var COMMENT_CACHE_KEY = "dgfattCommentKey";

// 管理员名称,评论时添加 [博主] 后缀
var ADMIN_NAME = "dgfatt";
...
$(document).ready(setTimeout(function () { // 延迟1s执行，保证其余的先加载
        ...
        console.log("~~~~记得有时间多来看看哦，https://dgfatt.github.io/")
    }
    ,
    500
))
